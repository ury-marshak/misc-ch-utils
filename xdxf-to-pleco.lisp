...
(eval-when (:compile-toplevel :load-toplevel :execute)
  (defparameter +pleco-old-colors+ t))
...
(defparameter +pleco-blue+ #. (coerce (if +pleco-old-colors+
                                            (list (code-char #xEAC1)
                                                  (code-char #x8000)
                                                  (code-char #x80FF))
                                            (list (code-char #xEAC1)
...
(defparameter +pleco-red+ #. (coerce (if +pleco-old-colors+
                                           (list (code-char #xEAC1)
                                                 (code-char #x8FF0)
                                                 (code-char #x8000))
                                           (list (code-char #xEAC1)
                                                 ...
                                                 (code-char #x8000)))
                                     'string))
(defparameter +pleco-gray+ #. (coerce (if +pleco-old-colors+
                                             (list (code-char #xEAC1)
                                                   (code-char #x8000)
                                                   (code-char #x8044))
                                             (list (code-char #xEAC1)
